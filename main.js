...
async function getRequestForRegion(zipcode, cookie, code) {
    ...
    try{
        ...
        if(existingDoc) {
            ...
            console.log('--- push region: ', zipcode);
            ...
            //     console.log("---------Dentist AddressID: ", dentists[i].AddressId, ', ', code);
            //     // try {
        ...
        console.log("------------ getRequestForRegion Error: ", error.message);
...
async function getRequestForDentist(profile, cookie){
    ...
    try{
        ...
        if(response.data.Profile.WebSite){
            ...
            console.log('---- no website:', addressId);
        }
        // }
